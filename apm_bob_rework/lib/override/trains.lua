...
local buildNuclearLocomotive = function(recipe, tier, armoured)
    ...
    apm.lib.utils.recipe.ingredient.mod(recipe, tier.bearing, 40)
    ...
    apm.lib.utils.recipe.ingredient.mod(recipe, apm.bob_rework.lib.entities.electricEngineUnit, 20 + 5 * tier.level)
