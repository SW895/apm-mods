...
local modify = function()
    ...
    for _, recipe in pairs(recipies1) do
        apm.lib.utils.recipe.ingredient.remove_all(recipe)
        --apm.lib.utils.recipe.ingredient.mod(recipe, robo.antenna.basic, 1)
        --apm.lib.utils.recipe.ingredient.mod(recipe, store.storehouse, 1)
        --apm.lib.utils.recipe.ingredient.mod(recipe, t.red.logic, 5)
        --apm.lib.utils.recipe.ingredient.mod(recipe, t.red.extraLogic, 2)
        apm.lib.utils.recipe.ingredient.mod(recipe, 'roboport-antenna-1', 1)
        apm.lib.utils.recipe.ingredient.mod(recipe, 'storehouse-basic', 1)
        apm.lib.utils.recipe.ingredient.mod(recipe, t.red.logic, 5)
    end
    ...
    for _, recipe in pairs(recipies2) do
        apm.lib.utils.recipe.ingredient.remove_all(recipe)
        --apm.lib.utils.recipe.ingredient.mod(recipe, robo.antenna.basic, 1)
        --apm.lib.utils.recipe.ingredient.mod(recipe, store.warehouse, 1)
        --apm.lib.utils.recipe.ingredient.mod(recipe, t.red.logic, 5)
        --apm.lib.utils.recipe.ingredient.mod(recipe, t.red.extraLogic, 2)
        apm.lib.utils.recipe.ingredient.mod(recipe, 'roboport-antenna-1', 1)
        apm.lib.utils.recipe.ingredient.mod(recipe, 'warehouse-basic', 1)
        apm.lib.utils.recipe.ingredient.mod(recipe, t.red.logic, 5)
    end
